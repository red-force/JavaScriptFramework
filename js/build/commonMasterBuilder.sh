#! /bin/bash -
# commonMasterBuilder.sh

# Output usage information
commonMasterBuilder(){
	OutputUsage(){
		echo "commonMasterBuilder works with UglifyJS2 .";
		...
		echo "Example:";
		echo "bash commonMasterBuilder.sh -l -p /workspace/jquery/collection/CommonMaster/js/build/ -s commonMaster.js.builder.txt";
		echo "NOTE : the build config file commonMaster.js.builder.txt should be with unix file format.";
		echo "now enjoy.";
